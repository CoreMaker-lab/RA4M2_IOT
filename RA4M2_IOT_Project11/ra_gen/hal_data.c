...
{ .scan_mask = ADC_MASK_CHANNEL_13 | 0,
  .scan_mask_group_b = 0,
...
const sci_i2c_extended_cfg_t g_i2c2_cfg_extend =
        {
        /* Actual calculated bitrate: 399902. Actual SDA delay: 300 ns. */.clock_settings.clk_divisor_value = 0,
          .clock_settings.brr_value = 4, .clock_settings.mddr_value = 182, .clock_settings.bitrate_modulation = true, .clock_settings.cycles_value =
                  27,
          .clock_settings.snfr_value = (1), };

const i2c_master_cfg_t g_i2c2_cfg =
{ .channel = 2, .rate = I2C_MASTER_RATE_FAST, .slave = 0x6B, .addr_mode = I2C_MASTER_ADDR_MODE_7BIT,
#define RA_NOT_DEFINED (1)
#if (RA_NOT_DEFINED == RA_NOT_DEFINED)
  .p_transfer_tx = NULL,
#else
